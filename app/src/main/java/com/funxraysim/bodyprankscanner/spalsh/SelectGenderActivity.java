...
public class SelectGenderActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        toolbarHeaderText = "Select Gender";
        ...
        binding.toolbarLayout.headerTitle.setText("Select Gender");
        ...
        binding.btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.equals("btnFullBodyScan")) {
                    ...
                    Intent intent = new Intent(SelectGenderActivity.this, AgeActivity.class);
                    startActivity(intent);
                } else if (name.equals("btnExploreBodyPart")) {

                    Intent intent = new Intent(SelectGenderActivity.this, ExploreBodyPartActivity.class);
                    startActivity(intent);
    ...
    private void setupLanguageList() {
        ...
        languageList.add(new LanguageModel("Male", R.drawable.img_gen_male, true));
        languageList.add(new LanguageModel("Female", R.drawable.img_gen_female, false));
        languageList.add(new LanguageModel("Other", R.drawable.img_gen_trans, false));
