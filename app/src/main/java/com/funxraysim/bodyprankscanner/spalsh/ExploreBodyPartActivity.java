...
public class ExploreBodyPartActivity extends BaseActivity {
    ...
    private void setClickListeners() {
        binding.btnHair.setOnClickListener(v -> openDetails(
                "Hair",
                R.drawable.hair,
        ...
        binding.btnEar.setOnClickListener(v -> openDetails(
                "Ear",
                R.drawable.ear,
        ...
        binding.btnEyebrows.setOnClickListener(v -> openDetails(
                "Eyebrows",
                R.drawable.eyebrows,
        ...
        binding.btnHand.setOnClickListener(v -> openDetails(
                "Hand",
                R.drawable.hand,
        ...
        binding.btnLeg.setOnClickListener(v -> openDetails(
                "Leg",
                R.drawable.leg,
        ...
        binding.btnKnee.setOnClickListener(v -> openDetails(
                "Knee",
                R.drawable.knee,
        ...
        binding.btnTongue.setOnClickListener(v -> openDetails(
                "Tongue",
                R.drawable.tongue,
        ...
        binding.btnFace.setOnClickListener(v -> openDetails(
                "Face",
                R.drawable.face,
        ...
        binding.btnNose.setOnClickListener(v -> openDetails(
                "Nose",
                R.drawable.nose,
        ...
        binding.btnLip.setOnClickListener(v -> openDetails(
                "Lips",
                R.drawable.lips,
        ...
        binding.btnNeck.setOnClickListener(v -> openDetails(
                "Neck",
                R.drawable.neck,
        ...
        binding.btnArm.setOnClickListener(v -> openDetails(
                "Arm",
                R.drawable.arm,
        ...
        binding.btnEye.setOnClickListener(v -> openDetails(
                "Eye",
                R.drawable.eye,
        ...
        binding.btnChest.setOnClickListener(v -> openDetails(
                "Chest",
                R.drawable.chest,
        ...
        binding.btnStomach.setOnClickListener(v -> openDetails(
                "Stomach",
                R.drawable.stomach,
